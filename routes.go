...
func RoutesMap(api *ApiConnection) Routes {
	var routes = Routes{
		...
		Route{"UpdateProduct", "POST", "/newproduct", api.UpdateProduct},
		Route{"DeleteProduct", "POST", "/newproduct", api.DeleteProduct},
		Route{"ListProducts", "POST", "/newproduct", api.ListProducts},
	}
